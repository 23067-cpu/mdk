...
export default function ProfilePage() {
    ...
    const handleProfileSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            error(t('common.error'), err instanceof Error ? err.message : t('profile.update_error'));
        } finally {
    ...
    const handlePasswordSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            error(t('common.error'), err instanceof Error ? err.message : t('profile.password_error'));
        } finally {
